...
python menu_rag_match_before.py --mode build --dict menu_final_with_allergen.json --index_dir rag_index


실행 코드 
python menu_rag_match_before.py --mode run ^
  --meta ocr_output/image3_run_meta.json ^
  --index_dir rag_index ^
